...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6661494944 ').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002304474918') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002304474918')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002244316214')).split()]  # For Multiple Id Use One Space Between Each.

DB_CHANNEL = int(environ.get("DB_CHANNEL", "-1002244316214")) 
SECONDARY_DB_CHANNEL = int(environ.get("SECONDARY_DB_CHANNEL", "-1002244316214")) #file chaneel 
